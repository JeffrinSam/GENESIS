# GENESIS — Part 2b: Video-to-Manipulation (DC-GR00T)

[![arXiv](https://img.shields.io/badge/arXiv-2509.13903-b31b1b.svg)](https://arxiv.org/abs/2509.13903)
[![Status](https://img.shields.io/badge/status-under%20development-orange.svg)]()

> **⚠️ Under Active Development** — The DC-GR00T manipulation pipeline is a research preview. Closed-loop real-robot validation is ongoing. APIs and checkpoints may change.

**DC-GR00T** (Demo-Conditioned GR00T) extends NVIDIA GR00T-N1.6 with a video demonstration encoder, enabling the robot to learn manipulation tasks directly from reference videos rather than language instructions alone.

**Paper:** "PhysicalAgent: Towards General Cognitive Robotics with Foundation World Models" — arXiv:2509.13903  
*Artem Lykov, Jeffrin Sam, et al. — Skoltech, 2025*

See the [GENESIS root README](../README.md) for the full pipeline and quick-start.

---

<!-- Upstream Isaac GR00T documentation follows -->
<div align="center">
...
## RTX 5090 Fine-Tuning Support

**NEW**: DC-GR00T N1.6 3B can be fine-tuned on NVIDIA RTX 5090 (32GB VRAM) using LoRA!

✅ **Memory**: 19.5GB / 32GB (60% usage)
✅ **Speed**: 1.15 sec/step
✅ **Performance**: 86% GPU utilization, 60°C temperature
...
python scripts/demo_conditioned/train_dc_groot.py \
  ...
  --max_steps 5000 \
  --bf16 \
  --run_name dc_groot_rtx5090
```

**Complete Documentation**: See [`docs/rtx5090_solution/`](docs/rtx5090_solution/) for:
- Complete setup guide with all compatibility fixes
- LoRA integration (already applied in codebase)
- Troubleshooting guide
- Performance metrics and optimization tips

**Helper Scripts**: [`scripts/rtx5090_helpers/`](scripts/rtx5090_helpers/) contains proven training scripts ready to use.
...
If you use the DC-GR00T manipulation pipeline from GENESIS, please cite:
...
Please also cite the upstream GR00T N1 foundation model:
