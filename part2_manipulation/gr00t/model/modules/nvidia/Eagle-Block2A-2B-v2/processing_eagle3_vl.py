...
# VideoInput type alias (not available in transformers < 4.56)
try:
        ...
        def replace_in_text(text):
            ...
            def repl(match):
                ...
                if media_type == 'image':
                    ...
                    image_kwargs = {k: v for k, v in output_kwargs["images_kwargs"].items() if k != "disable_grouping"}
                    image_inputs = self.image_processor(images=[image_list[idx_in_list]], videos=None, **image_kwargs)
